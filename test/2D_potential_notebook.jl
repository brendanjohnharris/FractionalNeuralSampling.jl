...
begin
	...
	Pkg.add([ # These are quick to install
		"Distributions"
		"LinearAlgebra"
	])
end
...
Pkg.add.([ # These may take a few minutes to install
	"CairoMakie"
	"Foresight"
])
...
Pkg.add(url="https://github.com/brendanjohnharris/FractionalNeuralSampling.jl", rev="main") # This is an unregistered package 
